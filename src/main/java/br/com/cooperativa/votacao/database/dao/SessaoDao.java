...
public class SessaoDao {
    ...
    public Sessao registrarSessaoDeVotacao(Sessao sessao, Integer tempoExpiracao) {
        String sql = "INSERT INTO sessao(id_pauta, data_abertura, data_encerramento) VALUES (?, ?, ?)";
        ...
        try (Connection connection = connectionFactory.criarConexao(); PreparedStatement ps = connection.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS);) {
            ...
            ps.setObject(2, dataAtual);
            ps.setObject(3, tempoExpiracao == null ? dataAtual.plusMinutes(1) : dataAtual.plusMinutes(tempoExpiracao));
            ps.executeUpdate();
